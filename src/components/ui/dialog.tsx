    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close
          className="absolute right-4 top-4 rounded-full p-1 opacity-70 transition-opacity hover:bg-slate-100 hover:opacity-100 focus:outline-none disabled:pointer-events-none"
        >
