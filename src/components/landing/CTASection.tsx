  ...
  return (
    <section className="relative z-10 py-20 px-6 lg:px-16 max-w-[1400px] mx-auto">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-200 to-slate-300 p-8 md:p-16 text-center shadow-2xl">
        {/* Heading */}
        <h2 className="text-3xl md:text-5xl font-black text-[#1e293b] mb-6 leading-tight">
        ...
        {/* Action Button */}
        <button className="bg-[#2563eb] hover:bg-blue-700 text-white px-8 py-4 rounded-xl text-lg font-bold transition-all shadow-xl shadow-blue-500/30 flex items-center justify-center gap-3 mx-auto">
